<?php /* Smarty version 2.6.18, created on 2013-06-11 14:04:20
         compiled from gywm.html */ ?>
...
.png" alt="蝶讯电子" />&nbsp;&nbsp;<?php echo $this->_tpl_vars['type2']['classname']; ?>
        ...
        <?php else: ?>
        <p><a href="index.php?action=gywm&nid=<?php echo $this->_tpl_vars['type2']['nid']; ?>
...
<div class="newright">
	<div class="title">
    	<div class="left"></div>
        <div class="mid">
            <p><?php echo $this->_tpl_vars['gywm']['title']; ?>
</p>
        </div>
        <div class="right"></div>
        <div class="cl"></div>    	
