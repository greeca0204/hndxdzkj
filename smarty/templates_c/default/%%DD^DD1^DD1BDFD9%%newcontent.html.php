<?php /* Smarty version 2.6.18, created on 2013-06-12 12:40:24
         compiled from newcontent.html */ ?>
...
<a href="index.php?action=news&id=<?php echo $this->_tpl_vars['type']['id']; ?>
...
<div class="newright">
	<div class="title">
    	<div class="left"></div>
        <div class="mid">
            <p><?php echo $this->_tpl_vars['new']['title']; ?>
</p>
        </div>
        <div class="right"></div>
        <div class="cl"></div>    	
	...
	<div class="content_cgal">
		<?php echo $this->_tpl_vars['new']['content']; ?>
